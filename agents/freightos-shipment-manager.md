...
### "Get me a quote for a 40HC container from OriginPort to DestPort"
Use CLI: `get-quote --origin XXORG --destination XXDST --loadtype container40HC --weight 15000`

### "Compare sea vs air for 2 tonnes of pallets"
Use CLI: `compare-rates --origin XXORG --destination XXDST --loadtype pallets --weight 2000`
...
### "Where is shipment REF-2024-001?"
...
```
## Freight Quote: OriginPort -> DestPort
